...
Ductwork automatically detects and restarts threads that have stopped responding, keeping your pipelines running without manual intervention.
...
Stuck thread detection is separate from [Step Timeouts](/docs/pro/step-timeout/), which is a Pro feature.
