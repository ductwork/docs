...
Ductwork uses the terms **workflow** and **pipeline** interchangeably. Do they actually have different meanings? Maybe? Pipelines tend to be more linear and workflows imply orchestration or have multiple branches, but in actuality the definitions are squishy and overlap.
