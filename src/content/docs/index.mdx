...
- **[Installation](getting-started/installation/)** - Install Ductwork and run your first pipeline
- **[Defining Pipelines](getting-started/defining-pipelines/)** - The DSL for connecting steps and managing the flow of work
- **[Durability](advanced/durability/)** - How Ductwork persists, claims, fences, and recovers every unit of work
- **[Concurrency](architecture/concurrency/)** - Ductwork's multi-process, multi-threaded execution model
...
Jump into the [Installation Guide](getting-started/installation/) and run your first durable pipeline in minutes, or read [how durability works](advanced/durability/) first.
