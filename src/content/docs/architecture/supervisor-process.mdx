...
See [Signal Handling](/docs/advanced/signal-handling) for detailed shutdown behavior.
...
See [TTIN Signal Handling](/docs/advanced/signal-handling/#ttin-signal-handling) for details.
...
See [Lifecycle Hooks](/docs/advanced/lifecycle-hooks/) for all available hooks.
