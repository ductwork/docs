...
The `start` transition defines your pipeline's entry point. This step receives the arguments passed to the `.trigger` method (see [Running Pipelines](/docs/getting-started/running-pipelines/)).
